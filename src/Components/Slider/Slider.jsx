...
const Slider = () => {
    ...
    <>
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 text-white p-10 space-y-7">
            <h2 className="text-4xl md:text-8xl text-shadow-lg/80 text-shadow-black font-bold">Build Connections, One Meal at a Time</h2>
            <p className='text-shadow-lg/80 text-shadow-black'>Discover food lovers near you. Share, manage, and <br /> track your fridge like never before.</p>
